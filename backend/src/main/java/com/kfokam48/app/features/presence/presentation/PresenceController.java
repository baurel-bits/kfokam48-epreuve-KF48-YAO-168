...
/**
 * {@code POST /api/presences} — opération imposée du contrat (EF2).
 * Codes de statut possibles : {@code 201}, {@code 400 CODE_INCONNU},
 * {@code 409 DEJA_PRESENT}, {@code 410 CODE_EXPIRE}, {@code 429 TROP_DE_TENTATIVES}.
 */
@RestController
